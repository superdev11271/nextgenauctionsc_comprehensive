...
use App\Http\Controllers\AutobidIntervalController;
...
use App\Http\Controllers\ChatTamplateController;
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function() {
    Route::get('/generate-or-reset-vapid', function () {
        $keys = VAPID::createVapidKeys();
        updateEnv('VAPID_PUBLIC_KEY',$keys['publicKey']);
        updateEnv('VAPID_PRIVATE_KEY',$keys['privateKey']);
    });

    Route::controller(ContactUsController::class)->group(function () {
        Route::get('/contactus-quries', 'messages')->name('contactus.messages');
    });
    // category
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        Route::post('/products/new_arraival', 'updateNewArraival')->name('products.new_arraival');
        Route::post('/products/top_rate', 'updateTopRate')->name('products.top_rate');
        Route::post('/products/best_seller', 'updateBestSeller')->name('products.best_seller');
        ...
        Route::post('/products/update_auction_product_status', 'updateAuctionProductStatus')->name('auction.products.updates');
    ...
    Route::controller(ProductBulkUploadController::class)->group(function () {
        ...
        Route::post('/brand-bulk-upload/generat_product_sheet', 'generate_marketplace_upload_sheet')->name('admin.generate_product_sheet');
        ...
        Route::get('/auction-product-bulk-upload', 'auction_upload')->name('admin.aucton_product_bulk_upload');

        Route::post('/auction-product-bulk-store', 'auction_bulk_upload')->name('admin.bulk_auction_product_upload');

        Route::post('/generate-acution-sheet', 'generate_auction_upload_sheet')->name('admin.generate_auction_sheet');
    ...
    Route::controller(SellerController::class)->group(function () {
        ...
        Route::get('/sellers/view/{id}/agreement', 'show_agreement')->name('sellers.show_agreement');
        ...
        Route::post('/sellers/premium', 'updatePremium')->name('sellers.permium');
        Route::post('/sellers/commission', 'updateCommission')->name('sellers.commission');
        Route::post('/sellers/remark', 'verification_remark')->name('seller.remark');
    });
    ...
    Route::controller(CustomerController::class)->group(function () {
        ...
        Route::post('customers/store', 'store_customer')->name('customers.stores');
        ...
        Route::get('/customers/details/{id}', 'details')->name('customers.details');
    });
    ...
    Route::controller(BusinessSettingsController::class)->group(function () {
        ...
        Route::post('/business-settings/single_update', 'single_update')->name('business_settings.single_update');

        Route::get('/business-settings/live_auction_settings', 'LiveAuctionSettings')->name('business_settings.live_auction_settings');
        Route::post('/business-settings/bulk_update', 'bulk_updates')->name('business_settings.bulk_update');
    ...
    Route::group(['prefix' => 'website'], function() {
        Route::controller(WebsiteController::class)->group(function () {
            ...
            Route::get('/contact-us', 'contactus')->name('website.contactus');
            Route::get('/about-us', 'aboutus')->name('website.aboutus');
            Route::get('/product-notification-setting', 'ProductNotificationSettings')->name('website.product-notification-setting');

        });

        Route::resource('email-templates', EmailTemplateController::class);
        Route::get('send-custom-notifications', [PushNotificationController::class,'sendBrowserNotificationToAll'])->name('app-translations.store');
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        // Profit
        Route::get('/profit/auction-product', 'auction_product_profit')->name('profit.auction-product');
        Route::get('/profit/market-product', 'market_product_profit')->name('profit.market-product');
    ...
    // Message Tamplates
    Route::controller(ChatTamplateController::class)->group(function () {
        Route::get('/system/chat-tamplates', 'index')->name('chat.tamplate.index');
        Route::post('/system/chat-tamplates/store', 'store')->name('chat.tamplate.store');
        Route::post('/system/chat-tamplates/update/{chatTamplate}', 'update')->name('chat.tamplate.update');
        Route::get('/system/chat-tamplates/destroy/{chatTamplate}', 'destroy')->name('chat.tamplate.delete');
    });
    // Autobid amount interval
    Route::controller(AutobidIntervalController::class)->group(function () {
        Route::get('/system/autobid', 'index')->name('autobid.index');
        Route::post('/system/autobid/store', 'store')->name('autobid.store');
        Route::post('/system/autobid/update/{autobid}', 'update')->name('autobid.update');
        Route::get('/system/autobid/destroy/{autobid}', 'destroy')->name('autobid.delete');
    });
