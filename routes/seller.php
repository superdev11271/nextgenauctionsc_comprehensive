...
Route::group(['namespace' => 'App\Http\Controllers\Seller', 'prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user', 'prevent-back-history'], 'as' => 'seller.'], function () {
    ...
    Route::controller(ProductBulkUploadController::class)->group(function () {
        ...
        Route::post('/brand-bulk-upload/generat_product_sheet', 'generate_marketplace_upload_sheet')->name('generate_product_sheet');

        Route::get('/auction-product-bulk-upload', 'auction_upload')->name('aucton_product_bulk_upload');

        Route::post('/auction-product-bulk-store', 'auction_bulk_upload')->name('bulk_auction_product_upload');

        Route::post('/generate-acution-sheet', 'generate_auction_upload_sheet')->name('generate_auction_sheet');
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        Route::get('/my-orders','my_orders')->name('orders.my_orders');
    });
    ...
    Route::controller(ReviewController::class)->group(function () {
        ...
        Route::post('/publish', 'publish')->name('reviews.publish');
    });
