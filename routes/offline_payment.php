...
Route::post('/purchase_hist2010 Ford Focus XR5 LV Manual Hatchbackory/make_payment/submit', [ManualPaymentMethodController::class, 'submit_offline_payment'])->name('purchase_history.make_payment');
