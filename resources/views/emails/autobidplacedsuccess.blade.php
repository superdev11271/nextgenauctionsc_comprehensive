                        ...
                        <tr>
                            <td style="font-size:13px;color:#1b2143;line-height:22px;background-color:#191919">
                                <h4
                                    ...
                                    Subject: Autobid successfully placed - NextGen Auctions & Marketplace
                                </h4>
                                <p style="padding:0px 20px;margin-bottom:35px;text-align:left;color:#888888;">
                                    Dear {{ $array['user_name'] ?? 'User' }} ,
                                    <br>
                                    <br>
                                    We are pleased to inform you that your Autobid has been placed successfully on
                                    NextGen Auctions & Marketplace. Your maximum bid of {{ $array['current_bided_amount'] ?? ''}} is now set to auto bid
                                    on your behalf in your absence at the NextGen Auctions & Marketplace automatic
                                    schedule.
                                    <br>
                                    <br>
                                    Rest assured, our automated system will manage your bids efficiently, ensuring you
                                    remain competitive while staying within your maximum bid limit, If you become outbid
                                    you will be notified.
                                    <br>
                                    You can view and manage your bids at any time by logging into your account on our
                                    website: <a style="font-size:14px;line-height:36px;color:#BE800F;font-weight:bold;"
