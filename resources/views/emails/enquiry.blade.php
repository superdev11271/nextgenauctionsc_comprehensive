                        ...
                        <tr>
                            <td style="font-size:13px;color:#1b2143;line-height:22px;background-color:#191919">
                                <h4
                                    ...
                                    Subject: Thank You for Contacting NextGen Auctions & Marketplace
                                </h4>
                                <p style="padding:0px 20px;margin-bottom:35px;text-align:left;color:#888888;">
                                    Dear {{ $mailData['name'] ?? 'User' }} ,
                                    <br>
                                    Thank you for reaching out to NextGen Auctions & Marketplace!
                                    <br><br>
                                    We have received your enquiry, and our support team is currently reviewing it. We
                                    understand the importance of your query and will respond to you as soon as possible,
                                    typically within 24-48 hours.
                                    <br>
                                    <br>
                                    To help us assist you better, please ensure that you have provided all relevant
                                    details regarding your enquiry. If you need to provide additional information or
                                    have further questions, please reply to this email or contact our support team
                                    directly at @if (get_setting('helpline_number'))
