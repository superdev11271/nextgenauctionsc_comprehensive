            ...
            <td align="center" style="padding:0;">
                <table role="presentation"
                    ...
                    <tr style="border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;">
                        <td align="left"
                            style="padding:10px 25px;background:#fff; display: flex; align-items: center;">
                            <span style="font-weight: bold; padding-top: 10px;">

                                @if ($header_logo != null)
                                    <img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}"
                                        width="" height="24" border="0" alt="">
                                @else
                                ...
                                <tr>
                                    <td style="padding:0 0 36px 0;color:#153643;">
                                        ...
                                        <p
                                            ...
                                            We wanted to inform you that the product <strong>"{{ ucfirst($productName) }}"</strong> is not sold. If you are interested in purchasing it, Please contact the seller using the button below or visit the bid history page.
                                        </p>
                                        ...
                                        <p style="margin:100px 0 12px 0;font-size:14px;font-family:Arial,sans-serif;">
                                            Thank you, </p>
                                        <p style="margin:0 0 12px 0;font-size:14px;font-family:Arial,sans-serif;"><a
                                                href="">NextGen Auction</a> </p>
                                    </td>
                                </tr>
                            </table>
                        </td>
