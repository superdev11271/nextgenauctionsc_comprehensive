            ...
            <div class="card-body">
                <form action="{{ route('shipping_configuration.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="radio mar-btm">
                        ...
                        <label for="flat-shipping">{{translate('Home Delivery Shipping Cost')}}</label>
                    </div>
                    <div class="radio mar-btm">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        2. {{ translate('Home Delivery Shipping Cost calculation: How many products a customer purchase, doesn\'t matter. Shipping cost is fixed') }}.
                    </li>
                    <li class="list-group-item">
