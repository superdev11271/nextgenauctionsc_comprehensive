        ...
        <div class="card-body">
                ...
                <div class="col-md-4 ml-auto">
                    <table>
                        <tbody>
                            ...
                            <tr>
                                <td class="text-main text-bold">{{ translate("Buyers' Premium") }}</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($orderDetail->product != null && $orderDetail->product->auction_product == 0)
                                            ...
                                            <a href="{{ route('product', $orderDetail->product->slug) }}" target="_blank">
                                                <img height="50" src="{{ uploaded_asset($product_stock?->image) }}">
                                            </a>
                                            @else
                                            <a href="{{ route('product', $orderDetail->product->slug) }}" target="_blank">
                                                <img height="50" src="{{ uploaded_asset($orderDetail->product->photos) }}">
                                            </a>
                                            @endif
                                    ...
                                    <td>
                                        @if ($orderDetail->product != null && $orderDetail->product->auction_product == 0)
                                            ...
                                            <div>
                                                {{$orderDetail->product->auction_product?"Auction Product":"Marketplace Product"}}
                                            </div>
                                            <br>
                                    ...
                                    @endif
                                    <td class="text-center">
                                        {{ single_price(($orderDetail->price / $orderDetail->quantity)-$buyersPremium) }}
                                    </td>
                                    {{-- <td class="currency">
                                    ...
                                    <td class="text-center">
                                        {{ single_price($orderDetail->price+$orderDetail->tax-$buyersPremium) }}
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
            ...
            <div class="clearfix float-right  w-100 w-lg-auto">
                <table class="table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                {{ single_price($order->orderDetails->sum('price')-$totalBuyersPremium) }}
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <strong class="text-muted">{{ translate('Buyers Premium') }} :</strong>
                            </td>
                            <td>
                                {{ single_price($totalBuyersPremium) }}
                            </td>
                        </tr>
                        @endif
                        <tr>
                ...
                <div class="no-print text-right">
                    <a href="{{ route('invoice.download', encrypt($order->id)) }}" type="button" class="btn btn-icon btn-light"><i
