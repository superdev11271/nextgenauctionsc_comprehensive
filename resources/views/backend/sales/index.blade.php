    ...
    <div class="card">
        <form class="" action="" id="sort_orders" method="GET">
            <div class="card-header row gutters-5">
                ...
                <div class="col-lg-2 ml-auto  mb-2 mb-lg-0">
                ...
                <table class="table aiz-table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th data-breakpoints="md">{{ translate('Product Type') }}</th>
                    ...
                    <tbody>
                        @foreach ($orders as $key => $order)
                            <tr>
                                ...
                                <td>
                                    {{ $order->orderDetails()->whereRelation('product','auction_product',1)->count()?'Auction Order':'Marketplace Order' }}
                                </td>
                                <td>
                                ...
                                <td class="text-right text-nowrap">
                                    @if (addon_is_activated('pos_system') && $order->order_from == 'pos')
                                        <a class="btn btn-soft-success btn-icon btn-circle btn-sm"
                                            href="{{ route('admin.invoice.thermal_printer', encrypt($order->id)) }}" target="_blank"
                                    ...
                                    @can('delete_order')
                                        <a href="#"
                                            ...
                                            data-href="{{ route('orders.destroy', encrypt($order->id)) }}"
