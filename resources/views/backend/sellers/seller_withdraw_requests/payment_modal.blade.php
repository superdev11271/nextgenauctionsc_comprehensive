      ...
      <table class="table table-striped table-bordered" >
        ...
        @if ($user->shop?->admin_to_pay > 0)
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    @if ($seller_withdraw_request->amount > $user->shop?->admin_to_pay)
                        <input type="number" lang="en" min="0" step="0.01" name="amount" id="amount" value="{{ $user->shop?->admin_to_pay }}" class="form-control" readonly required>
                    @else
                        <input type="number" lang="en" min="0" step="0.01" name="amount" id="amount" value="{{ $seller_withdraw_request->amount }}" class="form-control" readonly required>
                    @endif
                </div>
            </div>
