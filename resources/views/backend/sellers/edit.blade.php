        ...
        <div class="card-body">
          ...
          <form action="{{ route('sellers.update', $shop->id) }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{translate('Email Address')}}"  name="email" class="form-control" value="{{$shop->user->email}}" required>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label class="col-md-3 col-form-label" for="confirm_password">{{ translate('Confirm Password') }}</label>
