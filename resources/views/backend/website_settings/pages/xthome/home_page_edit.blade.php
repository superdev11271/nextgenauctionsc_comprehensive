         ...
         <li class="nav-item">
          <a class="nav-link" id="brands-tab" href="#brands"
           ...
           {{ translate('Top Brands') }}
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="contact-section-tab" href="#contact-section" data-toggle="tab"
                            data-target="#contact-section" type="button" role="tab" aria-controls="contact-section"
                            aria-selected="false">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="home_slider" role="tabpanel" aria-labelledby="home-slider-tab">
                        ...
                        <form action="{{ route('business_settings.update') }}" method="POST"
                            ...
                            <input type="hidden" name="types[][{{ $lang }}]" value="home_slider_head_one">
                            <input type="hidden" name="types[][{{ $lang }}]" value="home_slider_head_two">
                            <input type="hidden" name="types[][{{ $lang }}]" value="home_slider_head_three">

                            <div class="bg-white p-3 p-sm-2rem">
                                <div class="w-100">
                                    <!-- Information -->
                                    <div class="fs-11 mb-2rem">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div class="mb-2">
                                                ...
                                                {{ translate('Minimum 664 px or higher  X 490px') }}</div>
                                            <div class="mb-2">
                                                <label class="aiz-switch aiz-switch-success mb-0 fw-900">
                                                    Show/Hide Home Slider
                                                    <input onchange="updateSetting(this)"
                                                        data-setting="{{ encrypt('show_home_slider') }}"
                                                        value="{{ get_setting('show_home_slider') }}" type="checkbox"
                                                        @if (get_setting('show_home_slider')) checked @endif>
                                    ...
                                    <div class="alert alert-info" role="alert">
                                        {{ __('Please add the background-removed images for the home banner!') }}
                                    </div>
                                    <!-- Images & links -->
                                    <div class="home-slider-target">
                                        @php
                                            ...
                                            $home_slider_head_three = get_setting(
                                                'home_slider_head_three',
                                                null,
                                                $lang,
                                            );
                                        @endphp
                                            ...
                                            @foreach (json_decode($home_slider_images, true) as $key => $value)
                                                <div class="p-3 p-md-4 mb-3 mb-md-2rem remove-parent"
                                                    ...
                                                    <div class="row gutters-5">
                                                        ...
                                                        <div class="col-md">
                                                            <div class="form-group mb-md-0">
                                                                <textarea class="form-control" placeholder="Heading One" name="home_slider_head_one[]">{{ isset(json_decode($home_slider_head_one, true)[$key]) ? json_decode($home_slider_head_one, true)[$key] : '' }}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-md">
                                                            <div class="form-group mb-md-0">
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    name="home_slider_head_two[]"
                                                                    value="{{ isset(json_decode($home_slider_head_two, true)[$key]) ? json_decode($home_slider_head_two, true)[$key] : '' }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md">
                                                            <div class="form-group mb-md-0">
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    name="home_slider_head_three[]"
                                                                    value="{{ isset(json_decode($home_slider_head_three, true)[$key]) ? json_decode($home_slider_head_three, true)[$key] : '' }}">
                                                            </div>
                                                        </div>
                                        ...
                                        <button type="button"
											...
											<div class="p-3 p-md-4 mb-3 mb-md-2rem remove-parent" style="border: 1px dashed #e4e5eb;">
												<div class="row gutters-5">
                                                    ...
                                                    <div class="col-md">
														<div class="form-group mb-md-0">
															<input type="text" class="form-control" placeholder="Heading One" name="home_slider_head_one[]" value="">
														</div>
													</div>
                                                    <div class="col-md">
														<div class="form-group mb-md-0">
															<input type="text" class="form-control" placeholder="Heading Two" name="home_slider_head_two[]" value="">
														</div>
													</div>
                                                    <div class="col-md">
														<div class="form-group mb-md-0">
															<input type="text" class="form-control" placeholder="Heading Three" name="home_slider_head_three[]" value="">
														</div>
													</div>
													<!-- remove parent button -->
													<div class="col-md-auto">
                    ...
                    @if (addon_is_activated('auction'))
                        ...
                        <div class="tab-pane fade" id="auction" role="tabpanel" aria-labelledby="auction-tab">
                            <form action="{{ route('business_settings.update') }}" method="POST"
                                ...
                                <input type="hidden" name="types[][{{ $lang }}]"
                                    value="auction_banner_head_one">
                                <input type="hidden" name="types[][{{ $lang }}]"
                                    value="auction_banner_head_two">
                                <input type="hidden" name="types[][{{ $lang }}]"
                                    value="auction_banner_head_three">
                                <input type="hidden" name="types[][{{ $lang }}]"
                                    value="auction_banner_url_link">
                                <input type="hidden" name="types[][{{ $lang }}]" value="auction_date_range">
                                ...
                                @php
                                    ...
                                    $auction_banner_head_one = get_setting('auction_banner_head_one', null, $lang);
                                    $auction_banner_head_two = get_setting('auction_banner_head_two', null, $lang);
                                    $auction_banner_head_three = get_setting('auction_banner_head_three', null, $lang);
                                    $auction_banner_url_link = get_setting('auction_banner_url_link', null, $lang);
                                @endphp
                                ...
                                <div class="bg-white p-3 p-sm-2rem">
                                    <div class="w-100">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label" for="start_date">{{ translate('Heading One') }}
                                                <span class="text-danger"></span></label>
                                            <div class="form-group mb-md-0">
                                                <textarea class="form-control" placeholder="Heading One" name="auction_banner_head_one">{{ get_setting('auction_banner_head_one', null, $lang) }}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label" for="start_date">{{ translate('Heading Two') }}
                                                <span class="text-danger"></span></label>
                                            <div class="form-group mb-md-0">
                                                <input type="text" class="form-control" placeholder="Heading Two"
                                                    name="auction_banner_head_two"
                                                    value="{{ get_setting('auction_banner_head_two', null, $lang) }}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label"
                                                for="start_date">{{ translate('Heading Three') }} <span
                                                    class="text-danger"></span></label>
                                            <div class="form-group mb-md-0">
                                                <input type="text" class="form-control" placeholder="Heading Three"
                                                    name="auction_banner_head_three"
                                                    value="{{ get_setting('auction_banner_head_three', null, $lang) }}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label"
                                                for="start_date">{{ translate('Redirect Url Link') }} <span
                                                    class="text-danger"></span></label>
                                            <div class="form-group mb-md-0">
                                                <input type="text" class="form-control" placeholder="Link"
                                                    name="auction_banner_url_link"
                                                    value="{{ get_setting('auction_banner_url_link', null, $lang) }}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label"
                                            ...
                                            <div class="form-group mb-md-0">
                                                <input type="text" class="form-control aiz-date-range"
                                                    ...
                                                    value="{{ get_setting('auction_date_range', null, $lang) }}"
            ...
            <div class="bg-white p-3 p-sm-2rem">
                <div class="form-group">
                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                        ...
                        <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                        <input type="hidden" name="types[][{{ $lang }}]" value="contact_us_image">
                        <input type="hidden" name="contact_us_image" class="selected-files"
                            value="{{ get_setting('contact_us_image', null, $lang) }}">
                    </div>
                    <div class="file-preview box sm">
                    </div>
                </div>
...
@section('script')
    ...
    <script>
        ...
        function updateSetting(el) {
            ...
            $.post('{{ route('business_settings.single_update') }}', {
                _token: '{{ csrf_token() }}',
