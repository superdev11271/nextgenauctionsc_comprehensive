			...
			<div class="card-body">
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="border-top pt-3">
						<!-- Email  -->
                        <div class="form-group row">
							<label class="col-md-3 col-from-label">{{translate('Header Email')}}</label>
							<div class="col-md-8">
								<div class="form-group">
					...
					<div class="border-top pt-3">
                        ...
                        <div class="form-group row">
							<label class="col-md-3 col-from-label">{{translate('Header Note')}}</label>
							<div class="col-md-8">
								<div class="form-group">
									<input type="hidden" name="types[]" value="header_note">
									<input type="text" class="form-control" placeholder="{{ translate('Header Note') }}" name="header_note" value="{{ get_setting('header_note') }}">
								</div>
							</div>
						</div>
                    </div>
