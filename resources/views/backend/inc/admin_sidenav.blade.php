    ...
    <div class="aiz-sidebar left c-scrollbar">
        <div class="aiz-side-nav-logo-wrap">
            <a href="{{ route('admin.dashboard') }}" class="d-block text-left">
                ...
                <img class="mw-100 brand-icon" src="{{ uploaded_asset(get_setting('system_logo_white')) }}" alt="{{ get_setting('site_name') }}">
                @else
                <img class="mw-100 brand-icon" src="{{ static_asset('assets/img/logo.png') }}" alt="{{ get_setting('site_name') }}">
                @endif
            </a>
        </div>
        ...
        <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
            ...
            <li class="aiz-side-nav-item">
                <a href="#" class="aiz-side-nav-link">
                    ...
                    <span class="aiz-side-nav-text">{{ translate('Buyers') }}</span>
                ...
                <ul class="aiz-side-nav-list level-2">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('customers.index') }}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{ translate('All Buyer Listing') }}</span>
                        </a>
                    </li>
                    @endcan
                </ul>
            ...
            <li class="aiz-side-nav-item">
                <a href="#" class="aiz-side-nav-link">
                    ...
                    <span class="aiz-side-nav-text">{{ translate('Vendors/Sellers') }}</span>
                    <span class="aiz-side-nav-arrow"></span>
                </a>
                <!--Submenu-->
                <ul class="aiz-side-nav-list level-2">
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <a href="{{ route('sellers.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['sellers.index', 'sellers.create', 'sellers.edit', 'sellers.payment_history', 'sellers.approved', 'sellers.profile_modal', 'sellers.show_verification_request']) }}">
                            <span class="aiz-side-nav-text">{{ translate('All Vendor/Seller Listing') }}</span>
                ...
                <ul class="aiz-side-nav-list level-2">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('staffs.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['staffs.index', 'staffs.create', 'staffs.edit']) }}">
                            <span class="aiz-side-nav-text">{{ translate('All Staff Listing') }}</span>
                        </a>
                    </li>
                    @endcan
                        ...
                        <ul class="aiz-side-nav-list level-3">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('products.admin') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('All Admin Products') }}</span>
                                </a>
                            </li>
        ...
        <li class="aiz-side-nav-item">
            ...
            <ul class="aiz-side-nav-list level-2">
                ...
                <li class="aiz-side-nav-item">
                    <a href="javascript:void(0);" class="aiz-side-nav-link">
                        <span class="aiz-side-nav-text">{{ translate('Admin Auction Products') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-3">
                        ...
                        @endcan
                        @can('auction_bulk_improt')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.aucton_product_bulk_upload') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.aucton_product_bulk_upload']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Auction Bulk Import') }}</span>
                            </a>
                        </li>
                       @endcan
                ...
                @can('view_all_auction_products')
                <li class="aiz-side-nav-item">
                    <a href="{{ route('auction.attibutes') }}" class="aiz-side-nav-link {{ areActiveRoutes(['auction.attibutes']) }}">
                        <span class="aiz-side-nav-text">{{ translate('Manage Product Attributes') }}</span>
                    </a>
                </li>
                @endcan
                ...
                @can('current_bid_list')
                <li class="aiz-side-nav-item">
                    <a href="{{ route('auction_bid_product_admin') }}" class="aiz-side-nav-link {{ areActiveRoutes(['auction_bid_product_admin']) }}">
                        <span class="aiz-side-nav-text">{{ translate('Current Auction Bid List') }}</span>
                    </a>
                </li>
                @endcan
            </ul>
            ...
            <ul class="aiz-side-nav-list level-2">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('wholesale_products.in_house') }}" class="aiz-side-nav-link {{ areActiveRoutes(['wholesale_product_edit.admin']) }}">
                        <span class="aiz-side-nav-text">{{ translate('Admin Wholesale Products') }}</span>
                    </a>
                </li>
                @endcan
                @if (get_setting('vendor_system_activation') == 1)
        ...
        <!-- Customers -->
        {{-- @canany(['view_classified_products', 'view_classified_packages'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <div class="aiz-side-nav-icon">
        ...
        <li class="aiz-side-nav-item">
            <a href="#" class="aiz-side-nav-link">
                ...
                <span class="aiz-side-nav-text">{{ translate('Profit Reports') }}</span>
                <span class="aiz-side-nav-arrow"></span>
            </a>
            <!--Submenu-->
            <ul class="aiz-side-nav-list level-2">
                <li class="aiz-side-nav-item">
                    <a href="{{ route('profit.auction-product') }}" class="aiz-side-nav-link {{ areActiveRoutes(['profit.auction-product']) }}">
                        <span class="aiz-side-nav-text">{{ translate('Auction Product Reports') }}</span>
                    </a>
                </li>
                <li class="aiz-side-nav-item">
                    <a href="{{ route('profit.market-product') }}" class="aiz-side-nav-link {{ areActiveRoutes(['profit.market-product']) }}">
                        <span class="aiz-side-nav-text">{{ translate('Marketplace Product Reports') }}</span>
                    </a>
                </li>
            ...
            <ul class="aiz-side-nav-list level-2">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('wish_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['wish_report.index']) }}">
                        <span class="aiz-side-nav-text">{{ translate('Product Watchlist') }}</span>
                    </a>
                </li>
                @endcan
        ...
        @can('contact_enquires')
            <li class="aiz-side-nav-item">
            {{-- route('admin.contactus.messages')--}}
                <a href="{{ route('contactus.messages')}}" class="aiz-side-nav-link">
                    <div class="aiz-side-nav-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                    ...
                    <span class="aiz-side-nav-text">{{ translate('Enquiries') }}</span>
                </a>
            </li>
        @endcan
        <!--Blog System-->
        ...
        <li class="aiz-side-nav-item">
            <a href="#" class="aiz-side-nav-link">
                ...
                <span class="aiz-side-nav-text">{{ translate('News System') }}</span>
                <span class="aiz-side-nav-arrow"></span>
            </a>
            <ul class="aiz-side-nav-list level-2">
                @can('view_blogs')
        ...
        <!-- marketing -->
        @canany(['view_all_flash_deals', 'view_all_dynamic_popups', 'send_newsletter', 'send_bulk_sms',
        'view_all_subscribers', 'view_all_coupons'])
        <li class="aiz-side-nav-item">
            <a href="#" class="aiz-side-nav-link">
                <div class="aiz-side-nav-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
        ...
        <li class="aiz-side-nav-item">
            ...
            <ul class="aiz-side-nav-list level-2">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('email-templates.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['email-templates','email-templates.edit'],'active') }}">
                        <span class="aiz-side-nav-text">{{ translate('Notification Tamplates') }}</span>
                    </a>
                </li>
                @endcan
                ...
                @can('website_contact_us_settings')
                <li class="aiz-side-nav-item">
                    <a href="{{ route('website.contactus') }}" class="aiz-side-nav-link">
                        <span class="aiz-side-nav-text">{{ translate('Contact us') }}</span>
                    </a>
                </li>
                @endcan
                @can('website_about_us_settings')
                <li class="aiz-side-nav-item">
                    <a href="{{ route('website.aboutus') }}" class="aiz-side-nav-link">
        ...
        @canany(['general_settings', 'features_activation', 'language_setup', 'currency_setup',
        'vat_&_tax_setup', 'pickup_point_setup', 'smtp_settings', 'payment_methods_configurations',
        'order_configuration', 'file_system_&_cache_configuration', 'social_media_logins',
        'facebook_chat', 'facebook_comment', 'analytics_tools_configuration',
        'google_recaptcha_configuration', 'google_map_setting', 'google_firebase_setting',
        'shipping_configuration', 'shipping_country_setting', 'manage_shipping_states',
        ...
        @can('notification_days_setting')
        <li class="aiz-side-nav-item">
            <a href="{{ route('website.product-notification-setting') }}" class="aiz-side-nav-link">
                <span class="aiz-side-nav-text">{{ translate('Notification Alert Settings')}}</span>
            </a>
        </li>
        @endcan
        ...
        <li class="aiz-side-nav-item">
            <a href="{{ route('chat.tamplate.index') }}" class="aiz-side-nav-link">
                <span class="aiz-side-nav-text">{{ translate('Message Tamplates') }}</span>
            </a>
        </li>
        @endcan
        ...
        @canany(['smtp_settings'])
        <li class="aiz-side-nav-item">
            <a href="{{ route('autobid.index') }}" class="aiz-side-nav-link">
                <span class="aiz-side-nav-text">{{ translate('Autobid Intervals') }}</span>
            </a>
        </li>
        @endcan
        ...
        @canany(['smtp_settings'])
        <li class="aiz-side-nav-item">
            <a href="{{ route('business_settings.live_auction_settings') }}" class="aiz-side-nav-link">
