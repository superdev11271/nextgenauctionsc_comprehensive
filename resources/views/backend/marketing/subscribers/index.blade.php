                  ...
                  <tr>
                      ...
                      <td class="text-right">
                            @can('delete_subscriber')
                                <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('subscriber.destroy', encrypt($subscriber->id))}}" title="{{ translate('Delete') }}">
