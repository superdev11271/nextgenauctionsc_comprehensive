                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            @can('delete_size_charts')
                                <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('size-charts.destroy', encrypt($sizeChart->id))}}" title="{{ translate('Delete') }}">
