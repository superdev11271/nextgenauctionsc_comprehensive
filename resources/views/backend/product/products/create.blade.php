                ...
                <div class="tab-content">
                                ...
                                <div class="row">
                                    <div class="col-xxl-7 col-xl-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xxl-9">
                                                <input type="text" class="form-control" name="name" id="name" value="{{{ old('name') }}}" placeholder="{{ translate('Product Name') }}" oninput="this.value=this.value.replace(/[^A-Za-z\s0-9]/g,'')" onchange="update_sku()">
                    ...
                    {{-- <div class="tab-pane fade" id="price_and_stocks" role="tabpanel" aria-labelledby="price-and-stocks-tab"> --}}
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            {{-- </div> --}}
                <!-- Colors -->
                <h5 class="mb-3 pb-3 fs-17 fw-700" style="border-bottom: 1px dashed #e4e5eb;">{{translate('Variant attributes')}}</h5>
                <div class="w-100">
...
<div class="customer_choice_options mb-4" id="customer_choice_options">
                    ...
                    {{-- <div class="tab-pane fade" id="shipping" role="tabpanel" aria-labelledby="shipping-tab"> --}}
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <div class="w-100" id="pickup_section" >
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{ translate('Days') }}</label>
                                    <div class="col-md-9">
                                        <div class="input-group">
                    ...
                    <div class="mt-4 text-right">
                        <button type="submit"  onclick="checkRequiredAttributes()" name="button" value="unpublish" class="mx-2 btn btn-light  mb-3 mb-lg-0 w-230px btn-md rounded-2 fs-14 fw-700 shadow-secondary border-soft-secondary action-btn">{{ translate('Save & Unpublish') }}</button>
                        <button type="submit"  onclick="checkRequiredAttributes()" name="button" value="publish" class="mx-2 btn btn-success  mb-3 mb-lg-0 w-230px btn-md rounded-2 fs-14 fw-700 shadow-success action-btn">{{ translate('Save & Publish') }}</button>
                    </div>
