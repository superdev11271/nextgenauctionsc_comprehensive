                ...
                <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="tab-content">
                                ...
                                <div class="row">
                                    <div class="col-xxl-7 col-xl-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xxl-9">
                                                <input type="text" id="name" class="form-control"  oninput="this.value=this.value.replace(/[^A-Za-z\s0-9]/g,'')" name="name"
                                                    placeholder="{{ translate('Product Name') }}"
                                                    value="{{ old("name",$product->getTranslation('name', $lang)) }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xxl-9">
                                                <input type="text" class="form-control" name="expiry_date" placeholder="DD-MM-YYYY HH:MM" id="expirydate" 
                                                    value="{{ old('expiry_date', $product->auction_end_date ? \Carbon\Carbon::parse($product->auction_end_date)->format('d-m-Y H:i') : '') }}">
                        ...
                        <div class="mt-4 text-right">
                            <button type="button" onclick="!checkRequiredAttributes() && submitFormWithTab()" name="button"
...
<script>
    ...
    function showCategoryAttribues(category_id, product_id = null) {
            $.ajax({
                ...
                data: `category_id=${category_id}&_token={{ csrf_token() }}&product_id=${product_id}&edit=true`,
                success: function(data) {
                    if(data.status){
