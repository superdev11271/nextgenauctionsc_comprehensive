                            ...
                            <div class="d-flex flex-column justify-content-between h-100">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        <h3 class="fs-13 fw-600 text-secondary mb-0">{{ translate('Total Buyer') }}</h3>
                                    </div>
                                    <div class="mt-2">
            ...
            <div class="col-lg-6">
                <div class="row gutters-16">
                    ...
                    <div class="col-sm-6">
                        <div class="dashboard-box px-0 mb-2rem overflow-hidden" style="height: 474px;">
                            <div class="mb-2 px-2rem">
                                <h2 class="fs-16 fw-600 text-primary mb-1 h-40px">{{ translate('Admin Top Category') }}
                                </h2>
                                <h4 class="fs-13 fw-600 text-secondary mb-0">{{ translate('By Sales') }}</h4>
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="dashboard-box px-0 mb-2rem overflow-hidden" style="height: 474px;">
                            <div class="mb-2 px-2rem">
                                <h2 class="fs-16 fw-600 text-danger mb-1 h-40px">{{ translate('Admin Top Brands') }}</h2>
                                <h4 class="fs-13 fw-600 text-secondary mb-0">{{ translate('By Sales') }}</h4>
                            </div>
                ...
                <div class="dashboard-box bg-white mb-2rem overflow-hidden">
                    <div class="row gutters-16">
                        ...
                        <div class="col-sm-6 d-flex flex-column justify-content-between">
                            ...
                            <div>
                                <h2 class="fs-16 fw-600 text-dark mb-2rem">{{ translate('Admin Store') }}</h2>
                                <h1 class="fs-30 fw-600 text-dark mb-1">
                            ...
                            <a href="{{ route('inhouse_orders.index') }}"
                                class="btn btn-md btn-soft-info btn-block rounded-2 mt-4 mb-4 mt-sm-0 mb-sm-0">{{ translate('All admin Orders') }}</a>
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div
                                ...
                                <p class="fs-13 fw-600 text-primary mb-0">{{ translate('Admin product') }}</p>
                            </div>
