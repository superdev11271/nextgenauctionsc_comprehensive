...
<div class="aiz-titlebar text-left mt-2 mb-3">
	<div class="row align-items-center">
		<div class="col-md-6">
			<h1 class="h3">{{translate('All Auction Revenue')}}</h1>
		</div>
        {{-- @can('add_staff')
...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0 h6">{{ translate('All Auction Revenue') }}</h5>
    </div>
    <div class="card-body">
        <table class="table aiz-table mb-0">
            <thead>
                <tr>
                    ...
                    <th data-breakpoints="lg">{{ translate('Auction ID') }}</th>
                    <th data-breakpoints="lg">{{ translate('Lot ID') }}</th>
