...
<div class="aiz-titlebar text-left mt-2 mb-3">
	<div class=" align-items-center">
       <h1 class="h3">{{translate('Seller/Vendor Based Selling Report')}}</h1>
	</div>
</div>
<div class="row">
            ...
            <div class="card-body">
                <form action="{{ route('seller_sale_report.index') }}" method="GET">
                    <div class="form-group row offset-lg-2">
                        <label class="col-md-3 col-form-label mb-2 mb-lg-0">{{translate('Sort by verification status')}} :</label>
