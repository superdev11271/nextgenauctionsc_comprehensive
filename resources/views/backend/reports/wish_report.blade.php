...
<div class="aiz-titlebar text-left mt-2 mb-3">
	<div class=" align-items-center">
       <h1 class="h3">{{translate('Product Watch Report')}}</h1>
	</div>
</div>
            ...
            <div class="card-body">
                <form action="{{ route('wish_report.index') }}" method="GET">
                    <div class="form-group row offset-lg-2">
                        <label class="col-md-3 col-form-label mb-2 mb-lg-0">{{ translate('Sort by Category') }}:</label>
                ...
                <table class="table table-bordered aiz-table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th>{{ translate('Number of Watch') }}</th>
                        </tr>
                    </thead>
                    <tbody>
