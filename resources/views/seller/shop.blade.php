...
@section('panel_content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form id="shop-basic-info" class="" action="{{ route('seller.shop.update') }}" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="shop_id" value="{{ $shop->id }}">
                @csrf
                <div class="row">
                    <label class="col-md-2 col-form-label">{{ translate('Business Name') }}<span class="text-danger text-danger">*</span></label>
                    <div class="col-md-10">
                        <input type="text" class="form-control mb-3" placeholder="{{ translate('Shop Name')}}" name="name" value="{{ $shop->name }}"  oninput="this.value=this.value.replace(/[^A-Za-z\s]/g,'')" required>
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <label>{{ translate('Business Phone') }} <span class="text-danger">*</span></label>
                    </div>
                    <div class="col-md-10">
                        <input type="text" class="form-control mb-3" placeholder="{{ translate('Phone')}}" name="phone" value="{{ $shop->phone }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')" required>
                    </div>
                </div>
                <div class="row">
...
@section('script')
    ...
    $(document).ready(function () { 
        ...
        messages: {
            ...
            customWhitespaceValidation: "<span class='text-danger'>Please enter shop name</span>",
            },
            phone: {
            required: "<span class='text-danger'> Please enter Phone number </span>",
            customWhitespaceValidation: "<span class='text-danger'> Please enter phone number </span>",
            },
            address: {
            required: "<span class='text-danger'> Please enter address </span>",
            customWhitespaceValidation: " <span class='text-danger'>Please enter address </span>",
            }
        },
        tooltip_options: {
            name: {
