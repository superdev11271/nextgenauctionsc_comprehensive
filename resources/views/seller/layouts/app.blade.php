    ...
    <script>
        $(document).ready(function() {
            ...
            $("#support_ticket_form").validate({
                ...
                messages: {
                    subject: {
                        required: "<span class='text-danger'>Please enter subject</span>",
                        customWhitespaceValidation: "<span class='text-danger'>Please enter subject</span>",
                    },
                    details: {
                        required: "<span class='text-danger'>Please enter details</span>",
                        customWhitespaceValidation: "<span class='text-danger'>Please enter details</span>",
                    },
                },
                tooltip_options: {
                    subject: {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (emailInput) {
        emailInput.addEventListener("input", () => {
            ...
            if (value.includes("@")) {
                ...
                const filteredDomains = emailDomains.filter(domain => domain.startsWith(query));

                if (filteredDomains.length > 0) {
                    filteredDomains.forEach(domain => {
                        const suggestionItem = document.createElement("div");
                        suggestionItem.classList.add("suggestion-item");
                        suggestionItem.textContent = `${parts[0]}@${domain}`;
    ...
    document.addEventListener("click", (event) => {
        if (suggestionsContainer && !suggestionsContainer.contains(event.target) && event.target !== emailInput) {
            suggestionsContainer.style.display = "none";
        }
    });
});
