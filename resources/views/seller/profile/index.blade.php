...
@section('panel_content')
    ...
    <form  id="profile-form" action="{{ route('seller.profile.update', $user->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="name" value="{{ $user->name }}" id="name" class="form-control"  placeholder="{{ translate('Your Name') }}" oninput=this.value=this.value.replace(/[^A-Za-z\s]/g,'') required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="phone" value="{{ $user->phone }}" id="phone"  class="form-control" placeholder="{{ translate('Your Phone')}}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="bank_name" value="{{ $user->shop?->bank_name }}" id="bank_name" class="form-control mb-3" placeholder="{{ translate('Bank Name')}}" oninput="this.value=this.value.replace(/[^A-Za-z\s]/g,'')" >
                       
                    </div>
                </div>
                <div class="row">
                    <label class="col-md-3 col-form-label" for="bank_acc_name">{{ translate('Bank Account Holder Name') }} <span class="text-danger">*</span> </label>
                    <div class="col-md-9">
                        <input type="text" name="bank_acc_name" value="{{ $user->shop?->bank_acc_name }}" id="bank_acc_name"    oninput="this.value=this.value.replace(/[^A-Za-z\s]/g,'')" class="form-control mb-3" placeholder="{{ translate('Bank Account Holder Name')}}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="bank_acc_no" value="{{ $user->shop?->bank_acc_no }}"  oninput="this.value = this.value.replace(/[^0-9]/g, '')"  id="bank_acc_no" class="form-control mb-3" placeholder="{{ translate('Bank Account Number')}}">
                       
                    </div>
                </div>
                <div class="row">
                    <label class="col-md-3 col-form-label" for="bank_routing_no">{{ translate('Bank Routing Number') }} <span class="text-danger">*</span> </label>
                    <div class="col-md-9">
                ...
                @foreach ($addresses as $key => $address)
                    <div class="col-lg-4">
                        <div class="border p-3 pr-5 rounded mb-3 position-relative">
                            ...
                            <div class="">
                                    <span class="badge badge-inline badge-danger">{{ translate('Billing Address') }}</span>
                            </div>
                            @endif
                            @if ($address->address_type == 2)
                            <div class="">
                                    <span class="badge badge-inline badge-danger">{{ translate('Shipping address') }}</span>
                            </div>
                            @endif
                            @if ($address->address_type == 3)
                            <div class="">
                                    <span class="badge badge-inline badge-danger">{{ translate('Pickup address') }}</span>
                            </div>
                            @endif
                            ...
                            <div class="dropdown position-absolute right-0 top-0">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                    ...
                                    @endif
                                    <a class="dropdown-item" href="{{ route('seller.addresses.destroy', encrypt($address->id)) }}">{{ translate('Delete') }}</a>
                                </div>
                            </div>
              ...
              <div class="row">
                  ...
                  <div class="col-md-10">
                      <div class="input-group mb-3">
                        <input type="email" class="form-control" id="emailInput" placeholder="{{ translate('Your Email')}}" name="email" value="{{ $user->email }}" />
                    ...
                    <div class="modal-body">
                        <div class="p-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control mb-3" placeholder="{{ translate('Your Postal Code')}}" name="postal_code"    oninput="this.value = this.value.replace(/[^0-9]/g, '')" value="" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control mb-3" placeholder="{{ translate('+880')}}" name="phone" value="" oninput="this.value = this.value.replace(/[^0-9]/g, '')"  required >
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-6">
                                    <input type="radio" class=""  name="address_type" value="1" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-6">
                                    <input type="radio" class=""  name="address_type" value="2" required>
                                </div>
                            </div>
...
<script>
    $(document).ready(function () {
        ...
        messages: {
            ...
            customWhitespaceValidation: "<span class='text-danger'>Please enter Bank Name</span>",
            },
            bank_acc_name: {
            required: "<span class='text-danger'>Please enter Account Holder Name</span>",
            customWhitespaceValidation: "<span class='text-danger'>Please enter Account Holder Name</span>",
            },
            bank_acc_no: {
            required: "<span class='text-danger'>Please enter Bank Account Number</span>",
            customWhitespaceValidation: "<span class='text-danger'>Please enter Bank Account Number</span>",
            },
            bank_routing_no: {
            required: "<span class='text-danger'>Please enter Bank Routing Number</span>",
            customWhitespaceValidation: "<span class='text-danger'>Please enter Bank Routing Number</span>",
            },
        },
        tooltip_options: {
            bank_name: {
