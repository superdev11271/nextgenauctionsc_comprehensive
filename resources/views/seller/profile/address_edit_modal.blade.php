    ...
    <div class="p-3">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <input type="radio" class="" name="address_type" value="1"  @if($address_data->address_type == '1') checked @endif  required>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-6">
                <input type="radio" class="" @if($address_data->address_type =='2') checked  @endif name="address_type" value="2" required>
            </div>
        </div>
