...
@section('panel_content')
    ...
    <form class="" action="{{ route('seller.products.store') }}" method="POST" enctype="multipart/form-data" id="choice_form">
                ...
                <div class="bg-white p-3 p-sm-2rem">
                    ...
                    <div class="w-100">
                        <div class="row">
                            <div class="col-xxl-7 col-xl-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xxl-9">
                                        <input type="text" class="form-control" name="name" id="name" oninput="this.value=this.value.replace(/[^A-Za-z\s0-9]/g,'')" value="{{{ old('name') }}}" placeholder="{{ translate('Product Name') }}" onchange="update_sku()">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" lang="en" min="0" value="{{old("unit_price",0)}}" step="0.01" placeholder="{{ translate('Unit price') }}" name="unit_price" id="unit_price" class="form-control">
                                        <div id="unit_price-error" class="invalid-feedback"></div>
                                    </div>
                                </div>
                                <!-- SKU -->
                            {{-- <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xxl-9">
                                        <div class="input-group">
                                            <select name="unit" id="unit" class="form-control js-example-tags">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xxl-9">
                                        <input type="number" lang="en" class="form-control" name="min_qty" value="{{ old('min_qty',1) }}"  value="1" min="1">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xxl-9">
                                        <input type="text" class="form-control aiz-tag-input" value="" name="tags[]" placeholder="{{ translate('Type and hit enter to add a tag') }}">
                                        <small class="text-muted">{{translate('This is used for search. Input those words by which cutomer can find this product.')}}</small>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">Tax</label>
                                    <div class="col-md-9">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                            <input type="checkbox" onchange="toggleTaxSection(this)" name="tax_enabled" value="1">
                                            <span></span>
                                        </label>
                                    </div>
                                </div>

                                <div class="w-100 tax-section d-none">
                                ...
                                <div class="form-group row mt-4 mb-4">
                                    ...
                                    <div class="col-xxl-9">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                            <input type="checkbox" name="refundable" checked value="1"  @checked(old("refundable")=="1")>
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="h-300px overflow-auto c-scrollbar-light">
                                            ...
                                            data-keep-first-submenu-open="true"
                                            data-remove-parent-category-radio="true">
                        ...
                        @if(get_setting('marketplace_product_expiry'))
                            <div class="col-xxl-7 col-xl-6">
                                <div class="form-group row">
                                    <label class="col-xxl-3 col-form-label fs-13">{{ translate('Product Expiry') }}</label>
                                    <div class="col-xxl-9">
                                        <input type="text" class="form-control" name="expiry_date" 
                                            value="{{ old('expiry_date') }}" id="expiry_date_picker" placeholder="DD-MM-YYYY HH:MM">
                                    </div>
                                </div>
                            </div>
                         @endif
                         ...
                         <div class="" id="AttributeSection" style="display: none">
                            <div class="card">
                                <div class="">
                                    <h5 class="mb-3 mt-5 pb-3 fs-17 fw-700">{{ translate('Attributes') }}</h5>
                                </div>
                                <div class="card-body">
                                    <div class="form-group row">
                                        <div class="col-12">
                    ...
                    <div class="w-100">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <label class="aiz-switch aiz-switch-success mb-0 d-block">
                                    <input type="checkbox" name="featured" value="1" @checked(old("featured")=="1")>
                                    <span></span>
                                </label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <label class="aiz-switch aiz-switch-success mb-0 d-block">
                                    <input type="checkbox" name="todays_deal" value="1" @checked(old("todays_deal")=="1")>
                                    <span></span>
                                </label>
                ...
                <div class="bg-white p-3 p-sm-2rem">
                    ...
                    <div class="w-100">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="{{old("unit_price",0)}}" step="0.01" placeholder="{{ translate('Unit price') }}" name="unit_price" class="form-control"  required>
                            </div>
                        </div>
                        <!-- Discount Date Range -->
                        <div class="form-group row">
                            <label class="col-sm-3 control-label" for="start_date" data-toggle="tooltip" title="If you provide a date range, the discount will be applied only within the given dates.">{{translate('Select date range for discount')}}
                                <label class="aiz-switch aiz-switch-success mb-0 float-right" data-toggle="tooltip" title="Show date range">
                                    <input type="checkbox"  value=""  id="show-date-range">
                                    <span></span>
                                </label>
                            </label>
                            <div class="col-sm-6 d-none date-range">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Discount')}}</label>
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="{{old("discount",0)}}" step="0.01" placeholder="{{ translate('Discount') }}" name="discount"  class="form-control" >
                            </div>
                            <div class="col-md-3">
                        ...
                        @if(addon_is_activated('club_point'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="number" lang="en" min="0" value="0" step="1" placeholder="{{ translate('1') }}" name="earn_point" class="form-control"  required>
                                </div>
                            </div>
                        @endif
                        ...
                        <div id="show-hide-div">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="number" lang="en" min="0" value="{{old("current_stock",0)}}" step="1" placeholder="{{ translate('Quantity') }}" name="current_stock" class="form-control">
                                </div>
                            </div>
                    ...
                    {{-- </div> --}}
        <!-- Colors -->
        <h5 class="mb-3 pb-3 fs-17 fw-700" style="border-bottom: 1px dashed #e4e5eb;">{{translate('Attributes')}}</h5>
        <div class="w-100">
        <div class="form-group row gutters-5">
            ...
            <div class="col-md-1">
                <label class="aiz-switch aiz-switch-success mb-0" data-toggle="tooltip" title="Note: If you add variants to this product, it will become a variant product. The first variant will be displayed to customers. Please ensure the price of the first variant is the same as the unit price.">
                    <input value="1" type="checkbox" name="colors_active" @checked(old("colors_active")=="1")>
                    <span></span>
                </label>
            </div>
        </div>
        ...
        <div class="form-group row gutters-5">
            ...
            <div class="col-md-8">
                <select name="choice_attributes[]" id="choice_attributes" class="form-control aiz-selectpicker" data-selected-text-format="count" data-live-search="true" multiple data-placeholder="{{ translate('Choose Attributes') }}">
                    @foreach (\App\Models\Attribute::has('attribute_values')->get() as $key => $attribute)
...
<div class="customer_choice_options mb-4" id="customer_choice_options">
                    ...
                    <div class="w-100 mb-3">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="number" name="low_stock_quantity" value="{{old("low_stock_quantity",1)}}" min="0" step="1" class="form-control">
                            </div>
                        </div>
                    </div> --}}
                    ...
                    <div class="w-100">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="radio" name="stock_visibility_state" value="quantity" @checked(old("stock_visibility_state")=="quantity")>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="radio" name="stock_visibility_state" value="text" @checked(old("stock_visibility_state")=="text")>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="radio" name="stock_visibility_state" value="hide" @checked(old("stock_visibility_state")=="hide")>
                                    <span></span>
                                </label>
                            </div>
                        </div>
            ...
            {{-- <div class="tab-pane fade" id="shipping" role="tabpanel" aria-labelledby="shipping-tab"> --}}
                <div class="bg-white p-3 p-sm-2rem">
                    ...
                    <div class="w-100">
                        ...
                        @if (get_setting('cash_payment') == '1')
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input type="checkbox" name="cash_on_delivery" value="1" @checked(old("cash_on_delivery")=="1") >
                                        <span></span>
                                    </label>
                                </div>
                            </div>
                        ...
                        <!-- Pickup -->
                        {{-- <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Pickup')}}</label>
                            <div class="col-md-9">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="radio" name="shipping_type" value="free" @checked(old("shipping_type","free")=="free")>
                                    <span></span>
                                </label>
                            </div>
                        </div> --}}
                        <!-- Home Delivery -->
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Home Delivery')}}</label>
                            <div class="col-md-9">
                                <label class="aiz-switch aiz-switch-success mb-0">
                        ...
                        <!-- Shipping cost -->
                        <div class="flat_rate_shipping_div" >
                            <div class="form-group row">
                    ...
                    <!-- Estimate Shipping Time -->
                     ...
                     <!-- Pickup Time -->
                     {{-- <div class="w-100" id="shipping_days" style="display:none">
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Shipping Days')}}</label>
                            <div class="col-md-9">
                                <div class="input-group">
                    ...
                    {{-- <h5 class="mb-3 mt-4 pb-3 fs-17 fw-700" id="shipping_days_heading" style="border-bottom: 1px dashed #e4e5eb;display:none">{{translate('Estimate Shipping Time')}}</h5>
                     <!-- Pickup Time -->
                    <h5 class="mb-3 mt-4 pb-3 fs-17 fw-700" id="pickup_section_heading" style="border-bottom: 1px dashed #e4e5eb;">{{ translate('Pickup date / Time') }}</h5>
                    <div class="w-100" id="pickup_section" >
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{ translate('date') }}</label>
                            <div class="col-md-9">
                                <div class="input-group">
                                    <input type="text" class="form-control" id="pickdate" name="pickup_days"  required value="{{ old('pickup_days') }}" placeholder="{{ translate('Pickup date') }}">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroupPrepend">{{translate('date')}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{ translate('Times') }}</label>
                            <div class="col-md-9">
                                <div class="input-group">
                                    <input type="text" class="form-control " name="pickup_time" id="picktime" required  />
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroupPrepend">{{translate('Time')}}</span>
                                    </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 col-from-label">{{ translate('Pickup Address') }}</label>
                        <div class="col-md-9">
                            <div class="input-group">
                                <input type="text" class="form-control " value="{{ old('pickup_address')  }}" name="pickup_address" required    />
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroupPrepend">{{translate('Pickup Address')}}</span>
                                </div>
                        </div>
                    </div> --}}
                </div>
            ...
            <div class="mt-4 text-right">
                <button type="submit" name="button" onclick="checkRequiredAttributes()" value="unpublish" class="mx-2 btn btn-light w-230px btn-md rounded-2 fs-14 fw-700 shadow-secondary border-soft-secondary action-btn">{{ translate('Save & Unpublish') }}</button>
                <button type="submit" name="button" onclick="checkRequiredAttributes()" value="publish" class="mx-2 btn btn-success w-230px btn-md rounded-2 fs-14 fw-700 shadow-success action-btn">{{ translate('Save & Publish') }}</button>
            </div>
...
<script type="text/javascript">
        ...
        $('#expiry_date_picker').daterangepicker({
            singleDatePicker: true,         
            timePicker: true,               
            timePicker24Hour: true,       
        ...
        $('#expiry_date_picker').on('apply.daterangepicker', function(ev, picker) {
            $(this).val(picker.startDate.format('DD-MM-YYYY HH:mm'));
        });

        $('#expiry_date_picker').on('cancel.daterangepicker', function(ev, picker) {
            $(this).val('');
        });
        ...
        $('input[name="category_id"][type="radio"]').on("change", function() {
            ...
            $("#choice_form").on("submit",function(event){
                ...
                if (Unit_price === '') {
                    ...
                    $("#unit_price-error").text("This field is required");
                    errors = true;
                } else if (parseFloat(Unit_price) <= 0) {
                    $("#unit_price").addClass('is-invalid');
                    $("#unit_price-error").text("Unit price must be greater than 0");
                    errors = true;
                } else {
                    $("#unit_price").removeClass('is-invalid');
                    $("#unit_price-error").text("");
                }
...
<script>
    function validateTime(input) {
        ...
        const regex = /^(\d{1,2})(AM|PM)\s*TO\s*(\d{1,2})(AM|PM)$/i;
        let match = value.match(regex);

        if (match) {
            let startHour = match[1];
            let startPeriod = match[2];
            let endHour = match[3];
            let endPeriod = match[4];

            // Format the value
            value = `${startHour}${startPeriod} TO ${endHour}${endPeriod}`;
            input.classList.remove('is-invalid');
        } else {
            // Mark input as invalid if it doesn't match the format
    ...
    function toggleTaxSection(ele) {
        let element = $(ele);
        console.debug(element.prop('checked'));
        $('.tax-section').toggleClass('d-none')
