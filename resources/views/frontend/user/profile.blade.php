    ...
    <div class="card rounded-0 shadow-none border">
        ...
        <div class="card-body">
            <form action="{{ route('user.profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <label class="col-md-2 col-form-label fs-14">{{ translate('First Name') }}</label>
                    <div class="col-md-10">
                        <input type="text" class="form-control rounded-0" placeholder="{{ translate('First Name') }}" name="first_name" value="{{ Auth::user()->first_name }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-2 col-form-label fs-14">{{ translate('Last Name') }}</label>
                    <div class="col-md-10">
                        <input type="text" class="form-control rounded-0" placeholder="{{ translate('Last Name') }}" name="last_name" value="{{ Auth::user()->last_name }}">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label class="col-md-2 col-form-label fs-14">{{ translate('Street Number') }}</label>
                    <div class="col-md-10">
                        <input type="text" class="form-control rounded-0" placeholder="{{ translate('Street Number') }}" name="street_number" value="{{ Auth::user()->street_number }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-2 col-form-label fs-14">{{ translate('Street Name') }}</label>
                    <div class="col-md-10">
                        <input type="text" class="form-control rounded-0" placeholder="{{ translate('Street Name') }}" name="street_name" value="{{ Auth::user()->street_name }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-2 col-form-label fs-14">{{ translate('Suburb') }}</label>
                    <div class="col-md-10">
                        <input type="text" class="form-control rounded-0" placeholder="{{ translate('Suburb') }}" name="suburb" value="{{ Auth::user()->suburb }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-2 col-form-label fs-14">{{ translate('Postcode') }}</label>
                    <div class="col-md-10">
                        <input type="text" class="form-control rounded-0" placeholder="{{ translate('Postcode') }}" name="postal_code" value="{{ Auth::user()->postal_code }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-2 col-form-label fs-14">{{ translate('State') }}</label>
                    <div class="col-md-10">
                        <input type="text" class="form-control rounded-0" placeholder="{{ translate('State') }}" name="state" value="{{ Auth::user()->state }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-2 col-form-label fs-14">{{ translate('Driver License Number') }}</label>
                    <div class="col-md-10">
                        <input type="text" class="form-control rounded-0" placeholder="{{ translate('Driver License Number') }}" name="govt_id" value="{{ Auth::user()->govt_id }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-2 col-form-label fs-14">{{ translate('ID Proof Photo') }}</label>
                    <div class="col-md-10">
                ...
                <div class="form-group row">
                    <label class="col-md-2 col-form-label fs-14">{{ translate('Business Account') }}</label>
                    <div class="col-md-10">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="is_business" id="is-business-yes" value="1" {{ Auth::user()->is_business ? 'checked' : '' }}>
                            <label class="form-check-label" for="is-business-yes">{{ translate('Yes') }}</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="is_business" id="is-business-no" value="0" {{ !Auth::user()->is_business ? 'checked' : '' }}>
                            <label class="form-check-label" for="is-business-no">{{ translate('No') }}</label>
                        </div>
                    </div>
                </div>
                <div id="business-profile-fields">
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label fs-14">{{ translate('Business Name') }}</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control rounded-0" placeholder="{{ translate('Business Name') }}" name="business_name" value="{{ Auth::user()->business_name }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label fs-14">{{ translate('ABN/CAN') }}</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control rounded-0" placeholder="{{ translate('ABN/CAN') }}" name="abn_can" value="{{ Auth::user()->abn_can }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label fs-14">{{ translate('Business Phone') }}</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control rounded-0" placeholder="{{ translate('Business Phone') }}" name="business_phone" value="{{ Auth::user()->business_phone }}">
                        </div>
                    </div>
                </div>
                <!-- Photo-->
...
@section('script')
    <script type="text/javascript">
        function toggleBusinessFields() {
            const selectedValue = $('input[name="is_business"]:checked').val();
            if (selectedValue === '1') {
                $('#business-profile-fields').show();
            } else {
                $('#business-profile-fields').hide();
            }
        }
