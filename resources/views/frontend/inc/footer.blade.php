...
<div class="border-top" id="section_last_viewed_products" style="background-color: #fcfcfc;">
    ...
    @if (count($lastViewedProducts) > 0)
        <section class="mb-2 mb-md-3 mt-md-3 my-md-4">
            <div class="container">
                <!-- Top Section -->
                    ...
                    <div class="aiz-carousel sm-gutters-16 arrow-none" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='false'>
                        @foreach ($lastViewedProducts as $key => $lastViewedProduct)
                            <div class="carousel-box px-3 position-relative has-transition hov-animate-outline border-right border-top border-bottom @if($key == 0) border-left @endif">
                                @include('frontend.'.get_setting('homepage_select').'.partials.product_box_xt',['product' => $lastViewedProduct->product])
                            </div>
                        @endforeach
                    </div>
                </div>
            ...
            <div class="{{ $col_values }}">
                <div class="text-center text-sm-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2">
                            <a class="fs-13 text-soft-light animate-underline-white" href="{{ route('wishlists.auction') }}">
                                {{ translate('My Watchlist') }}
                            </a>
                        </li>
                        <li class="mb-2">
                ...
                <div class="container">
                    <ul class="list-unstyled mt-3">
                        ...
                        <li class="mb-2 pb-2 {{ areActiveRoutes(['wishlists.index'],' active')}}">
                            <a class="fs-13 text-soft-light text-sm-secondary animate-underline-white" href="{{ route('wishlists.auction') }}">
                                {{ translate('My Watchlist') }}
                            </a>
                        </li>
