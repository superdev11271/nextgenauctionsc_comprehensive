@if(!empty($todays_deal_products) && count($todays_deal_products) > 0)
    <section class="shop-section">
        <div class="auto-container  wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
            ...
            @if(count($todays_deal_products) >= '8')
            <div class="more-btn centred"><a href="{{ route('products.bestfeatured', ['type' => 'todays_deal']) }}" class="theme-btn-one">View All<i
