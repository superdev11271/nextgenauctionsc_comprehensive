            ...
            <tbody>
                ...
                @foreach ($carts as $key => $cartItem)
                    ...
                    <tr class="cart_item">
                        ...
                        <td class="product-total pr-0  text-grey border-bottom">
                            <span class="pl-4 pr-0"> {{ single_price(cart_product_price($cartItem, $cartItem->product, false, false) * $cartItem['quantity']) }}</span>
                        </td>
                    </tr>
        ...
        <table class="table" style="margin-top: 2rem!important;">
            <tfoot>
                ...
                <tr class="cart-subtotal">
                    <th class="pl-0 pt-0 pb-2 text-grey fw-700 border-bottom">{{ translate('Subtotal') }}</th>
                ...
                <tr class="cart-shipping">
                    <th class="pl-0 pt-0 pb-2 text-grey fw-700 border-bottom">{{ translate('Tax') }}</th>
                    <td class="text-right pr-0 pb-2 text-grey fw-500 border-bottom">
                ...
                <!-- Total Shipping -->
                <tr class="cart-shipping">
                    <th class="pl-0 pt-0 pb-2 text-grey fw-700 border-bottom">{{ translate('Total Shipping') }}</th>
                    <td class="text-right pr-0 pb-2 text-grey fw-500 border-bottom">
                ...
                @if (Session::has('club_point'))
                    <tr class="cart-shipping">
                        <th class="pl-0 pt-0 pb-2 text-grey fw-700 border-bottom">{{ translate('Redeem point') }}</th>
                        <td class="text-right pr-0 pb-2 text-grey fw-500 border-bottom">
                ...
                @if ($coupon_discount > 0)
                    <tr class="cart-shipping">
                        <th class="pl-0 pt-0 pb-2 text-grey fw-700 border-bottom">{{ translate('Coupon Discount') }}</th>
                        <td class="text-right pr-0 pb-2 text-grey fw-500 border-bottom">
                ...
                <!-- Total -->
                <tr class="cart-total">
                    <th class="pl-0  text-grey fw-700 border-bottom"><span class="strong-600">{{ translate('Total') }}</span></th>
                    ...
                    <form class="" id="remove-coupon-form" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                ...
                                class="theme-btn-card">{{ translate('Change Coupon') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <form class="" id="apply-coupon-form" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                ...
                                class="theme-btn-card">{{ translate('Apply') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
