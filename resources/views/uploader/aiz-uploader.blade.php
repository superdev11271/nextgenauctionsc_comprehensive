	...
	<div class="modal-dialog modal-adaptive" role="document">
		<div class="modal-content h-100">
			<div class="modal-header pb-0 bg-light">
				...
				<button type="button" class="{{str_contains(request()->headers->get('referer'),"seller")?'':'btn-'}}close" data-dismiss="modal" data-bs-dismiss="modal" aria-label="Close">
			...
			<div class="modal-footer justify-content-between bg-light">
				<div class="flex-grow-1 overflow-hidden d-flex">
					<div class="">
						<div class="aiz-uploader-selected aa">{{ translate('0 File selected') }}</div>
				...
				<button type="button" class="btn btn-sm btn-primary update-selected-image" data-toggle="aizUploaderAddSelected" disabled>{{ translate('Add Files') }}</button>
			</div>
		</div>
	</div>
</div>
