                        ...
                        @if ($order != null)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <span class="badge text-bg-danger py-2 font-size-12">{{ translate('Unpaid') }}</span>
                                    @endif
                                </td>
                                @if (addon_is_activated('refund_request'))
                                    <td>
                                ...
                                <td class="text-right  text-nowrap">
                                    ...
                                    @can('delete_order')
                                        <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{ route('orders.destroy', encrypt($order->id)) }}" title="{{ translate('Delete') }}">
