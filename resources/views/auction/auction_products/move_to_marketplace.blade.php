...
<div class="page-content">
    ...
    <div class="d-sm-flex">
        ...
        <div class="flex-grow-1 p-sm-3 p-lg-2rem mb-2rem mb-md-0">
            ...
            @endif
{{-- {{ dd($product) }} --}}
            <form action="{{route('auction.move_to_marketplace_store')}}" method="POST"  enctype="multipart/form-data" id="choice_form">
                @csrf
                                ...
                                <div class="row">
                                    <div class="col-xxl-7 col-xl-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xxl-9">
                                                <input type="text" class="form-control" name="name" value="{{{ old('name', $product->name) }}}" oninput="this.value=this.value.replace(/[^A-Za-z\s0-9]/g,'')" placeholder="{{ translate('Produsct Name') }}" onchange="update_sku()" required>
                                            </div>
                                        </div>
                                        <!-- Brand -->
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            value="{{ old('pickup_time') }}" placeholder="" >
                                            <div class="input-group-prepend">
