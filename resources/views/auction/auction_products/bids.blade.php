    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class="table mb-0 text-center">
                ...
                <tbody>
                        <tr>
                            <td class="w-25">{{$product->name }}
                            </td>
                            <td>{{$product->reserved_price }}
                            </td>
    ...
    <div class="card">
        <div class="card-header row gutters-5">
            <div class="col d-flex justify-content-between">
                ...
                @if (
                    $product->bids->where('notified', 0)->count() &&
                    ...
                    @foreach ($bids as $key => $bid)
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                @if ($bid->product->sold_status == '' && auth()->user()->can('delete_auction_product_bids'))
                                    <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete"
                                        data-href="{{ route('product_bids_destroy.admin', $bid->id) }}"
