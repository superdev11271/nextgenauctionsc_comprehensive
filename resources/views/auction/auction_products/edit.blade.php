...
@section('content')
    ...
    <div class="">
        ...
        @endif
        <form class="form form-horizontal mar-top" action="{{ route('auction_product_update.admin', $product->id) }}"
            ...
            <div class="row gutters-5">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control aiz-selectpicker" name="auction_number" id="auctionSelect"
                                        onchange="updateLotNo()">
                                        @foreach ($products as $previous_auctions)
                                            @if ($previous_auctions->auction_number == $product->auction_number)
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" oninput="this.value=this.value.replace(/[^A-Za-z\s0-9]/g,'')"
                                        class="form-control" name="name" placeholder="{{ translate('Product Name') }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                        ...
                                        @if ($auctionCount > 1) readonly disabled @endif
                    ...
                    <div class="card" id="pickup_section">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="pickup_days" id="pickdate"
                                        required value="{{ $product->pickup_days }}"
                                ...
                                <div class="input-group mt-2">
                                    <input type="text" list="time" class="form-control" id="picktime"
                                        name="pickup_time" id="pickup_time" required value="{{ $product->pickup_time }}"
                                        placeholder="">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"
                ...
                <div class="col-lg-12 col-md-12" id="AttributeSection" style="display: none">
                    <div class="card">
                        <div class="card-header">
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        var [startTime, endTime] = [moment().hours(12).minutes(0).seconds(0), moment().hours(23).minutes(59).seconds(0)]
        if(defaultPickupTime){
            [startTime, endTime] = defaultPickupTime.split('to');
        }
