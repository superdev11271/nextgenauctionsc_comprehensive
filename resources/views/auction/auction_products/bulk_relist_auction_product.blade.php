...
@section('content')
    ...
    <div class="">
        ...
        @endif
     <form id="bulk-relist-update-form" class="form form-horizontal mar-top"
      action="{{ route('auction.bulk_relist_auction_store') }}"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <input type="text" id="auctionNumberInput" class="form-control mt-2"
                                    value="{{ $auctionNumber }}" readonly>
                                </div>
                            </div>
                                ...
                                <div class="col-md-8">
                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                        ...
                                        <input type="hidden" name="banner_image" id="banner_image" class="selected-files"
                                            value="{{ $product->banner_image }}" readonly
                                            >
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="name"
                                        ...
                                        value="{{ $product->getTranslation('name', $lang) }}" oninput="this.value=this.value.replace(/[^A-Za-z\s0-9]/g,'')" required readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="auction_date_range" class="form-control aiz-date-range"
                                        ...
                                        data-past-disable="true" required>
                                </div>
                            </div>
            ...
            <div class="row gutters-5">
                ...
                <div class="col-12">
                    <div class="mb-3 text-right">
                        <button type="submit" onclick="checkRequiredAttributes(event)"
...
@section('script')
    ...
    <script>
$(function () {
    const FORM_SELECTOR = '#bulk-relist-update-form'; // Change to your actual form ID

    $(FORM_SELECTOR).on('submit.sweetalert', function (e) {
        ...
        Swal.fire({
            ...
            text: 'Do you want to approve and publish these products?',
            icon: 'question',
            showCancelButton: true,
            confirmButtonText: 'Yes, approve & publish',
            cancelButtonText: 'No, keep as draft'
        }).then((result) => {
            if (result.isConfirmed) {
                $form.find('input[name="published"]').val(1);
                $form.find('input[name="approved"]').val(1);
            } else {
                $form.find('input[name="published"]').val(0);
                $form.find('input[name="approved"]').val(0);
            }

            // Remove this SweetAlert handler before submitting again
            $form.off('submit.sweetalert');
