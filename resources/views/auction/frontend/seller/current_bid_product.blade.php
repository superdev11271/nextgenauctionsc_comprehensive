...
<div class="card">
    <form class="" id="sort_products" action="" method="GET">
        <div class="card-header row gutters-5">
            <div class="col">
                <h5 class="mb-md-0 h6">{{ translate('Current Bid Product') }}</h5>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            <a class="btn btn-soft-info btn-icon btn-circle btn-sm"  href="{{ route('product_bids.seller', encrypt($product->id)) }}" target="_blank" title="{{ translate('View All Bids') }}">
