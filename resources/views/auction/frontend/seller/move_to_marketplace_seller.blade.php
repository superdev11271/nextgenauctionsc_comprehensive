...
<div class="page-content">
    <div class="aiz-titlebar text-left mt-2 pb-2 px-3 px-md-2rem border-bottom border-gray">
        <div class="row align-items-center">
            <div class="col">
                <h1 class="h3">{{ translate('Move To Marketplace') }}</h1>
            </div>
    ...
    <div class="d-sm-flex">
        ...
        <div class="flex-grow-1 p-sm-3 p-lg-2rem mb-2rem mb-md-0">
            ...
            @endif
{{-- {{ dd($product) }} --}}
            <form action="{{route('auction.seller_move_to_marketplace_store')}}" method="POST"  enctype="multipart/form-data" id="choice_form">
                @csrf
                ...
                <div class="tab-content">
                    ...
                    {{-- <div class="tab-pane fade" id="general" role="tabpanel" aria-labelledby="general-tab"> --}}
                        <div class="bg-white p-3 p-sm-2rem">
                                ...
                                <div class="row">
                                    <div class="col-xxl-7 col-xl-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xxl-9">
                                                <input type="text" class="form-control" name="name" value="{{{ old('name', $product->name) }}}" placeholder="{{ translate('Produsct Name') }}" oninput="this.value=this.value.replace(/[^A-Za-z\s0-9]/g,'')" onchange="update_sku()" required>
                                            </div>
                                        </div>
                                        <!-- Brand -->
                                            ...
                                            <div class="card-body">
                                                <div class="h-300px overflow-auto c-scrollbar-light">
                                                    <ul class="hummingbird-treeview-converter list-unstyled" data-checkbox-name="category_ids[]" data-radio-name="category_id">
                                                        ...
                                                        <li id="{{ $category->id }}">{{ $category->getTranslation('name') }}</li>s
                            ...
                            <!-- Vat & TAX -->
                            <h5 class="mb-3 mt-4 pb-3 fs-17 fw-700" style="border-bottom: 1px dashed #e4e5eb;">{{translate('TAX')}}</h5>
                            <div class="w-100">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="true">
                                            ...
                                            <input type="hidden" name="photos" class="selected-files" value="{{ old('photos', $product->photos) }}">
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group" data-toggle="aizuploader" data-type="image">
                                            ...
                                            <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                            <input type="hidden" name="thumbnail_img" class="selected-files" value="{{ old('thumbnail_img', $product->thumbnail_img) }}">
                                        </div>
                                        <div class="file-preview box sm">
                                        </div>
                        ...
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <div class="w-100">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                            <input type="radio" name="shipping_type" value="flat_rate" @checked(old("shipping_type")=="flat_rate")>
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
