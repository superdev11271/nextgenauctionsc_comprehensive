...
@section('panel_content')
    ...
    <div class="">
        ...
        @endif
        <form class="form form-horizontal mar-top" action="{{ route('auction.seller_relist_auction_store') }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    value="{{ old($start_date . ' to ' . $end_date) }}" id="auction_date_range" name="auction_date_range"
                                        placeholder="{{ translate('Select Date') }}" data-time-picker="true"
                                        data-format="DD-MM-Y HH:mm:ss" data-separator=" to " autocomplete="off" data-past-disable="true" readonly>
                                </div>
                            </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="card d-none">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <div class="col-12">
                                    <textarea class="aiz-text-editor" name="terms_conditions">{{ old('terms_conditions', $product->getTranslation('terms_conditions', $lang)) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
