...
@section('panel_content')
        ...
        <div class="card-body">
            ...
            <tr>
                <td style="display: table-cell;" class="footable-first-visible footable-last-visible">
                    <form action="{{route('seller.generate_auction_sheet')}}" method="post">
                        @csrf
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal" action="{{ route('seller.bulk_auction_product_upload') }}" method="POST" enctype="multipart/form-data">
                @csrf
