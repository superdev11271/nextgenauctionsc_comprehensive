...
class WebsiteController extends Controller
{
    ...
    public function contactus(){
        ...
        return view('backend.website_settings.contactus');
    }

    public function aboutus(){
        return view('backend.website_settings.aboutus');
    }

    public function ProductNotificationSettings(){
        return view('backend.website_settings.product_notification_settings');
    }
