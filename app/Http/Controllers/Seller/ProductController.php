...
class ProductController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $categories = Category::where('parent_id', 0)
            ...
            ->get();
        return view('seller.product.products.create', compact('categories', 'units'));
    }
    ...
    public function store(ProductRequest $request)
    {
        ...
        if (addon_is_activated('seller_subscription')) {
            ...
            $shop->created_product_count  = (int)$shop->created_product_count+ 1;
            $shop->save();
        }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $categories = Category::where('parent_id', 0)
            ...
            ->with('childrenCategories')
            ->get();
        return view('seller.product.products.edit', compact('product', 'categories', 'tags', 'lang', 'units'));
    }
    ...
    public function duplicate($id)
    {
        ...
        if (addon_is_activated('seller_subscription')) {
            $shop = Shop::where('user_id',Auth::user()->id)->first();
            $shop->created_product_count = $shop->created_product_count +1;
            $shop->save();
        }
