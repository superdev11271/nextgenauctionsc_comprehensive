...
class ReviewController extends Controller
{
    ...
    {   
        if($request->comment == null || $request->rating== null){
            flash('Please provide your review comments. Thank you!')->warning();
            return back();    
        }
        $review = new Review;
        ...
        $review->photos = implode(',', $request->photo);
        $review->viewed = '0';
        $review->save();
    ...
    { 
        ...
        return view('frontend.' . get_setting('homepage_select') . '.modal.product_review_modal', compact('product', 'review'));
    }
}
