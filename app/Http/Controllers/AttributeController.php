...
class AttributeController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $data['attribute'] = Attribute::findOrFail(decrypt($id));
        $data['all_attribute_values'] = AttributeValue::with('attribute')->where('attribute_id',decrypt($id))->get();
    ...
    public function store_attribute_value(Request $request)
    {
        ...
        return redirect()->route('attributes.show', encrypt($request->attribute_id));
    }
    ...
    public function destroy_attribute_value($id)
    {
        ...
        return redirect()->route('attributes.show', encrypt($attribute_values->attribute_id));
