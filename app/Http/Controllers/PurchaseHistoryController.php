...
class PurchaseHistoryController extends Controller
{
    ...
    {
        $orders = Order::with('orderDetails')->where('user_id', Auth::user()->id)->orderBy('code', 'desc')->paginate(20);
        return view('frontend.xt-user.xt_view_order_history', compact('orders'));
    }
    ...
    public function purchase_history_details($id)
    {
        ...
        return view('frontend.xt-user.xt_order_details_customer', compact('order'));
    }
