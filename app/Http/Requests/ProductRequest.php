...
class ProductRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules['lot']  = 'nullable';
        $rules['estimate_start']  = 'sometimes|required';
        $rules['estimate_end']  = 'sometimes|required';
        $rules['shipping_info']  = 'nullable';
        $rules['terms_conditions']  = 'nullable';
        $rules['category_id']   = ['required', Rule::in($this->category_ids)];
        $rules['unit']         = 'sometimes|required|numeric';
